<?php require_once('inc/templateutils.php'); ?>
 ...
 lang="<?php echo $conf['lang']; ?>" dir="<?php echo $lang['direction']; ?>">
  ...
  <body>
    <div class="dokuwiki">
      <div class="stylehead">
        <div class="header">
          <div class="pagename"><a name="dokuwiki__dummy"><?php echo $ID ?></a></div>
          <div class="logo">
      ...
      <div class="breadcrumbs"><?php offlinehtml_breadcrumbs($breadcrumbs); ?></div>
      <div class="page">
        <!-- wikipage start -->
        <?php echo $content ?>
        <!-- wikipage stop -->
      ...
      <div class="bar" id="bar__bottom">
        ...
        <div class="bar-right" id="bar__bottomright">&nbsp;</div>
        <div class="clearer"></div>
      </div>
    </div>
  </body>
